...
public class Gamezinho extends JFrame {
    ...
    public void scenesgenerator() {
        ...
        if (cenasDisponiveis.isEmpty() && Pont_Sys.verifytovitory1 == 1 && Pont_Sys.verifytovitory2 == 1 
        		&& Pont_Sys.verifytovitory3 == 1 & Pont_Sys.verifytovitory4 == 1) {
